...
namespace Kvant
{
    ...
    public partial class Spray : MonoBehaviour
    {
        ...
        static float deltaTime {
            get {
                var isEditor = !Application.isPlaying || Time.frameCount < 100000;
                return isEditor ? 1.0f / 100 : Time.deltaTime;
            }
        }
...
//			Reticle
		...
		//	Ray r = Camera.main.ScreenPointToRay (this.transform.parent.gameObject.transform.position);
        ...
        void Update()
        {
			...
			//props.SetFloat("_ScaleMax", mouseDelta.x/2);
